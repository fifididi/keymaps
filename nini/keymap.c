...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_nini(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,
  ...
  [_CONTROL] = LAYOUT_nini(
    ...
    _______, RGB_M_P, RGB_M_B, RGB_M_R, RGB_MSW, RGB_MSN, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, _______, _______, _______,
  ...
  [nini] = LAYOUT_nini(
    ...
    _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, _______, _______, _______, _______, _______, _______, _______,
